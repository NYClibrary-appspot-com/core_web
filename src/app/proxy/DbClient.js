...
var DbClient = /** @class */ (function () {
    function DbClient() {
        this.uri = "mongodb+srv://user:Z3DFTdw8CUEarXkw@cluster0-vdmwi.mongodb.net/test?retryWrites=true&w=majority";
        this.DbName = "csciCloud";
        this.collec = "proxyDB";
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = this;
                        return [4 /*yield*/, mongodb_1.MongoClient.connect(this.uri, { useNewUrlParser: true })];
                    case 2:
                        _a.client = _b.sent();
